...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Senior CSR Assessment — ITNest Careers" },
      { name: "description", content: "Online assessment for the Senior Customer Service Representative role at ITNest." },
    ],
  }),
...
function AssessmentPage() {
  ...
  const handleBegin = async () => {
    await requestMedia();
    // Only proceed if we got media (or proceed anyway to not block)
    startTimer();
    setCurrentSection("a");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        {/* Recording Monitor - visible during test */}
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4 text-sm text-foreground/90">
                ...
                <div className="rounded-lg border border-primary/20 bg-primary/5 p-4">
                  <p className="font-semibold text-foreground text-sm">Time Limit: 30 Minutes</p>
