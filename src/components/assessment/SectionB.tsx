...
import { sectionBQuestions } from "@/data/assessment-questions";
...
export function AssessmentSectionB({ answers, setAnswers }: Props) {
    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center gap-2 mb-1">
          <Badge className="text-xs">Section B</Badge>
