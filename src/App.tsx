    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-4xl px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Senior Customer Service Representative — Online Assessment</p>
            </div>
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        {currentSection === "intro" && (
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Senior Customer Service Representative</CardTitle>
              <p className="text-sm text-muted-foreground mt-1">Online Assessment (OA)</p>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4 text-sm text-foreground/90">
                <p>Welcome to the ITNest Senior Customer Service Representative assessment. This test evaluates your knowledge, judgment, and critical thinking skills relevant to a senior-level customer service role.</p>
